...
class AddNewRowScreen extends StatefulWidget {
  static const routeName = '/addnew-row-screen';

  @override
  _AddNewRowScreenState createState() => _AddNewRowScreenState();
}

class _AddNewRowScreenState extends State<AddNewRowScreen> {
  File file;
  int counter = 0;
  ...
  void _onAddGarden(){
    if(_editingController.text.isEmpty){
      _errorText = "Row name must not be blank!";
      setState(() {
